> 2020 Disclaimer: If you have a need for this package, consider using [MDX](https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-plugin-mdx) instead.
